    ...
    <>
      ...
      <main id="main" className="pt-32 sm:pt-40">
        <div className="container mb-12">
          <p className="text-eyebrow uppercase text-electric-300/70">Open Cinema</p>
          <h1 className="mt-4 max-w-2xl font-display text-display-lg text-gradient-soft balance">
            Pick something, then pick someone
          </h1>
          <p className="mt-5 max-w-xl text-[1.0625rem] leading-relaxed text-white/45 pretty">
